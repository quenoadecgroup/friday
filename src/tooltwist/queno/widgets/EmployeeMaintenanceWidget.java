package tooltwist.queno.widgets;
...
import tooltwist.queno.productionHelpers.EmployeeMaintenanceProductionHelper;
...
//		instance.defineProperty(new WbdStringProperty("myProperty", null, "My Property", ""));
		instance.defineProperty(new WbdNavPointProperty("employeeList", null, "employeeList", ""));
	}
